...
> [Way2enjoy](https://way2enjoy.com) API wrapper for compressing JPG, PNG & GIF images, Audio & Video files


## Install
*Requires node `0.10.x` or above*

Install with [npm](https://npmjs.org/package/way2enjoy-gulp) - In your project folder, run:

```
npm install way2enjoy-gulp
```
...
var way2enjoy = require('way2enjoy-gulp');
...
Your Way2enjoy API key to use for requests
...
```bash
[09:47:43] way2enjoy-gulp Skipped: 0 images, Compressed: 1 image, Savings: 3.98 KB (ratio: 0.4109)
```
...
Enables concurrent uploads to the way2enjoy server to speed up total compression time.

<sub>(thanks [Way2enjoy2](https://github.com/way2enjoy2) for this feature suggestion)</sub>
